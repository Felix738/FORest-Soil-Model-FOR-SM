...
- data/processed/forest_biogeochemistry_lb_303_din.txt: Text file containing the processed results of forest biogeochemistry (DIN) for the Lange Bramke site including observation values from the monitoring program (ICP 303)
...
- data/processed/forest_biogeochemistry_sl_304_din.txt: Text file containing the processed results of forest biogeochemistry (DIN) for the Solling site including observation values from the monitoring program (ICP 304)
...
- data/processed/forest_biogeochemistry_kl_1503_din.txt: Text file containing the processed results of forest biogeochemistry (DIN) for the Klötze site including observation values from the monitoring program (ICP 1503)
