...
- data/processed/stem_volume_sl_1503_observed.txt: Text file containing the observed results of forest development for the Klötze site from the monitoring program (ICP 1503)
- data/processed/stem_volume_sl_1503_simulated.txt: Text file containing the simulated results of forest development for the Klötze site (ICP 1503) 
